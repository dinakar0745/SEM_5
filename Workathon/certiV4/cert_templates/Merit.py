...
# Load the template
template_path = 'test_cert/Merit.png'  # Path to the template image
output_path = 'test_cert/mccertificate.png'  # Output path for the generated certificate
...
name_font = ImageFont.truetype("fonts/AlexBrush.ttf", 80)  # Name font
other_font = ImageFont.truetype("fonts/OpenSans.ttf", 25)  # Other text font
...
name_position = (certificate.width // 2, 730)  # Center horizontally
cert_type_position = (1458, 865)  # Center horizontally
...
draw_centered_text(draw, str(Percentage), cert_type_position, other_font, "#302e2e")  # Certificate type
